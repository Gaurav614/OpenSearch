...
public class GatewayAllocatorTests extends OpenSearchAllocationTestCase {
    ...
    // assertEquals(0, testShardsBatchGatewayAllocator.getNumberOfStartedShardBatches());
    // assertEquals(0, testShardsBatchGatewayAllocator.getNumberOfStoreShardBatches());
    //
    ...
    // testShardsBatchGatewayAllocator.explainUnassignedShardAllocation(
    // clusterState.getRoutingNodes().shardsWithState(UNASSIGNED).get(0),
    // testAllocation
    // );
    //
    // // assert that new batches are created for failed shard
    // assertEquals(1, testShardsBatchGatewayAllocator.getNumberOfStartedShardBatches());
    // assertEquals(1, testShardsBatchGatewayAllocator.getNumberOfStoreShardBatches());
    //
    // }
