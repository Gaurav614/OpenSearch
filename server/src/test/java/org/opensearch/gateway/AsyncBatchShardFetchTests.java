...
public class AsyncBatchShardFetchTests extends OpenSearchTestCase {
    ...
    public void testClose() throws Exception {
        ...
        AsyncBatchShardFetch.FetchResult<Response> fetchData = test.fetchData(nodes, emptyMap());
    ...
    static class TestFetch extends AsyncBatchShardFetch<Response> {
        ...
        TestFetch(ThreadPool threadPool) {
            super(LogManager.getLogger(TestFetch.class), "test", Collections.singletonMap(new ShardId("test", "_na_", 1),""), null, "test-batch");
